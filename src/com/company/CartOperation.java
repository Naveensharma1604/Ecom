...
public class CartOperation {
    ...
    //  //add product to cart
    public  void addToCart(Cart cart, ProductOperation productOperations) {
    ...
    public void editFromCart(Cart cart, ProductOperation productOperations){
    ...
    public  void removeFromCart(Cart cart, ProductOperation productOperations) {
    ...
    //  //delete entire cart
    public void deleteCart(Cart cart, ProductOperation productOperations){
